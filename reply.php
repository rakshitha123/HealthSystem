        ...
        <div id="header">
         ...
         <div id="mainContent" style="height:500px;">
             ...
             <?php  // PHP code to print the subject of the message
	            ...
	            echo '<p class="style13" >'.$row['subject'].'</p>'; // Getting the subject of the message and print it
	      	    mysql_close();  
	        ?>
            ...
            <div id="message" style="padding-bottom:124px;">
                <form id="form1" name="form1" method="post" action="">
      
                   <?php
	                   echo '<p align="right">';
                       echo '<a href="answer.php?id=' . $id . '"><strong style="margin-right:34px">Reply</strong></a></p>';
					   //Display a hyperlink named as reply, which the doctor should have to click to reply to the question
                       mysql_connect('localhost','root','rakshitha');   // Connect to database
	  		           mysql_select_db('health');
				       ...
				       echo '<tr><td><b>From: </b></td><td>'.$row['firstName'].' '.$row['lastName'].'</td></tr>'; // Print patient's name
				       echo '<tr><td><b>Location: </b></td><td>'.$row['city'].'</td></tr>'; // Print patient's city
				       echo '</table></br>';
				       echo '<p style="padding-left:13px;">'.$row['question'].'</p>';  //Print patient's question
		          ?>
