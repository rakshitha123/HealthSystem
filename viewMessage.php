...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body class="oneColElsCtrHdr">
      <div id="container">
         ...
         <div id="mainContent" style="padding-bottom:31px;">
             ...
             <div id="message" style="padding-bottom:95px;">
                <form id="form1" name="form1" method="post" action="">
                  ...
                  <?php
				      ...
				      echo '<tr><td><b>From: </b></td><td>Dr. '.$row['firstName'].' '.$row['lastName'].'</td></tr>';  // Print doctor's name
				      echo '<tr><td><b>Category: </b></td><td>'.$row['category'].'</td></tr>';  // Print doctor category
				      echo '</table>';
				      echo '<p style="padding-left:13px;">'.$row['reply'].'</p>';  // Print the reply given by doctor
					  ...
					  $query2="UPDATE health.messages SET `read` = 'Y' WHERE messages.ID='".$id."';"; // Update the 'read' field of table to 'Y' to                                                                                    indicate that the message has read by the patient
